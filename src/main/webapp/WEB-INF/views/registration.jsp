f<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index" >Tritux</a>
...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin">
        ...
        <spring:bind path="userEmail">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="userEmail" class="form-control" placeholder="Email"
                            autofocus="true"></form:input>
